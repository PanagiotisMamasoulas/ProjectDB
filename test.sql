...
('lionarF','n_tri','2019-1-12 09:16:14','00:12:02',NULL,'2.8'),
('zazahir23','n_tri','2019-1-12 09:30:37','00:19:22',NULL,'3.7'),
('liagourma','msmith','2018-11-11 10:32:37','00:08:14',NULL,'4.6'),
('mnikol','msmith','2018-11-11 10:44:08','00:11:14',NULL,'2.9'),
('lionarF','msmith','2018-11-11 10:57:43','00:06:24',NULL,'4.1'),
('liagourma','Giankost','2019-1-11 16:10:54','00:12:34',NULL,'4.3'),
...
('zazahir23','bettyg','2019-4-13 19:23:12','00:27:32',NULL,'4.3'),
...
belongs_to varchar(36),
PRIMARY KEY (title),
CONSTRAINT TOMEAS FOREIGN KEY (belongs_to) REFERENCES field(title) ON DELETE CASCADE ON UPDATE CASCADE
)engine=InnoDB;
